...
//619526/52793/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LMP7701MA_NOPB" (originalName "LMP7701MA_NOPB")
	...
	(compDef "LMP7701MA_NOPB" (originalName "LMP7701MA_NOPB") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "8" (pinName "N/C_3") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "5" (pinName "N/C_2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LMP7701MA_NOPB"))
		...
		(attr "Mouser Part Number" "926-LMP7701MA/NOPB")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/LMP7701MA-NOPB?qs=7lkVKPoqpbb6Q12lvZ%252Bsng%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "LMP7701MA/NOPB")
		(attr "Description" "Precision, CMOS Input, RRIO, Wide Supply Range Single Amplifier")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/lmp7701")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "LMP7701MA_NOPB.stp")
