...
(library Library_1
	...
	(compDef "150080BS75000" (originalName "150080BS75000") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		...
		(attr "Description" "LED,Wurth Elektronik,150080BS75000 Wurth Elektronik 150080BS75000, WL-SMCW Series Blue LED, 470 nm 2012 (0805) Clear, Rectangle Lens SMD package")
		(attr "<Hyperlink>" "https://katalog.we-online.com/led/datasheet/150080BS75000.pdf")
		(attr "<Component Height>" "0.8")
		(attr "<STEP Filename>" "150080BS75000.stp")
		(attr "<STEP Offsets>" "X=-0.03;Y=0;Z=0.15")
